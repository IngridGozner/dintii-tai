...
const buttonClassName =
  'bg-white absolute top-[35%] md:top-[40%] lg:top-[45%] cursor-pointer z-10 w-12 aspect-square border-2 border-link hover:border-link-hover text-link hover:text-link-hover flex items-center justify-center';
