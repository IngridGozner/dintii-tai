        ...
        <div className="embla__dots flex flex-wrap justify-end items-center gap-2">
          {scrollSnaps.map((_, index) => (
            <DotButton
              ...
              className={'embla__dot inline-flex cursor-pointer border-2 rounded-full w-6 h-3 text-font shadow-lg'.concat(
                index === selectedIndex ? ' embla__dot--selected border-link' : ''
              )}
            />
          ))}
        </div>
