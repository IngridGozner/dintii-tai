  ...
  return (
    <footer>
      <Container contentClass='bg-base-dark p-10'>
        <GridContainer>
          <div className='col-span-6 flex flex-col gap-y-4 text-base md:gap-y-4 md:text-xl'>
            {phone && (
              <Link
                href={`tel:${phone}`}
                label={phone}
          ...
          {timetable && timetable.value && (
            <div className='col-span-6 flex text-base text-white md:text-xl lg:items-center lg:justify-center lg:leading-8'>
