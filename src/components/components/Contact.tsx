...
export default function Contact(props: NonNullable<FOOTER_SITEINFO_QUERYResult>) {
    ...
    return (
        <Container darkBackground>
            <GridContainer>
                <div className="col-span-6 md:col-span-4 lg:col-start-2">
                ...
                <div className="col-span-6 lg:col-start-7 lg:col-span-4 lg:pb-16 md:col-start-6">
                    <Headline headline={t('contactUs')} />
