...
export function Input(props: InputProps) {
    ...
    return (
        <div className="relative">
            <input id={element} type={type} name={element} className="peer w-full border-b placeholder:text-transparent bg-white p-3 rounded-full min-w-72" placeholder="name" />
